...
export function AccountModal({
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-2">
            ...
            {!isEditing && step === "details" && (
              <button
                ...
                className="text-[var(--color-text-muted)] hover:text-[var(--color-text)] animate-jiggle"
          ...
          {step === "details" ? (
            ...
            <div className="space-y-4">
              <div className="rounded-lg bg-[var(--color-bg-alt)] p-4 text-sm text-[var(--color-text-secondary)]">
                ...
                <p className="mt-1">
                  Enter the verification code sent to your Telegram account or
                  via SMS.
                </p>
              </div>
              <Input
      ...
      <TelegramHelpModal open={showHelp} onClose={() => setShowHelp(false)} />
    </>
  );
}
